...
int workspace_read_num(char *s);

struct workspace_config *workspace_find_config(int ws_num);

struct sway_output *workspace_get_initial_output(int num);

struct sway_workspace *workspace_create(struct sway_output *output, int num);
...
int workspace_next_num(const char *output_name);
...
struct sway_workspace *workspace_by_number(int num);

struct sway_workspace *workspace_by_desc(const char *);
...
void workspace_for_each_container(struct sway_workspace *ws,
                                  void (*f)(struct sway_container *con,
                                            void *data),
                                  void *data);
