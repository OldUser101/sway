...
struct sway_seatop_impl {
    ...
    void (*touch_motion)(struct sway_seat *seat,
                         struct wlr_touch_motion_event *event, double lx,
                         double ly);
    void (*touch_up)(struct sway_seat *seat, struct wlr_touch_up_event *event);
    void (*touch_down)(struct sway_seat *seat,
                       struct wlr_touch_down_event *event, double lx,
                       double ly);
    ...
    void (*tablet_tool_motion)(struct sway_seat *seat,
                               ...
                               uint32_t time_msec);
    void (*tablet_tool_tip)(struct sway_seat *seat,
...
struct sway_seat {
    ...
    int prev_workspace; // for workspace back_and_forth
...
void seat_add_device(struct sway_seat *seat, struct sway_input_device *device);
...
void seat_set_focus_surface(struct sway_seat *seat, struct wlr_surface *surface,
                            bool unfocus);

void seat_set_focus_layer(struct sway_seat *seat,
                          struct wlr_layer_surface_v1 *layer);

void seat_unfocus_unless_client(struct sway_seat *seat,
...
void seat_for_each_node(struct sway_seat *seat,
                        void (*f)(struct sway_node *node, void *data),
                        void *data);
