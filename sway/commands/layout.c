...
static enum sway_container_layout
parse_layout_string(char *s)
{
...
static enum sway_container_layout
toggle_split_layout(enum sway_container_layout layout,
...
static enum sway_container_layout
get_layout_toggle(int argc, char **argv, enum sway_container_layout layout,
                  enum sway_container_layout prev_split_layout,
                  struct sway_output *output)
{
    // "layout toggle"
...
static enum sway_container_layout
get_layout(int argc, char **argv, enum sway_container_layout layout,
           enum sway_container_layout prev_split_layout,
           struct sway_output *output)
{
...
cmd_layout(int argc, char **argv)
{
    ...
    if (container) {
        ...
        new_layout = get_layout(argc, argv, container->pending.layout,
                                container->prev_split_layout,
                                container->pending.workspace->output);
    } else {
        old_layout = workspace->layout;
        new_layout =
            get_layout(argc, argv, workspace->layout,
                       workspace->prev_split_layout, workspace->output);
    }
