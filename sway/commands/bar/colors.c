...
{
    char **colors[3] = {&(config->current_bar->colors.active_workspace_border),
...
{
    char **colors[3] = {&(config->current_bar->colors.binding_mode_border),
...
{
    char **colors[3] = {&(config->current_bar->colors.focused_workspace_border),
...
{
    char **colors[3] = {&(config->current_bar->colors.urgent_workspace_border),
