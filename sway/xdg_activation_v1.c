...
void
xdg_activation_v1_handle_request_activate(struct wl_listener *listener,
                                          void *data)
{
...
void
xdg_activation_v1_handle_new_token(struct wl_listener *listener, void *data)
{
    struct wlr_xdg_activation_token_v1 *token = data;
    struct sway_seat *seat =
        token->seat ? token->seat->data : input_manager_current_seat();
