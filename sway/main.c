...
detect_suid(void)
{
    ...
    sway_log(SWAY_ERROR,
             "SUID operation is no longer supported, refusing to start. "
...
static int
term_signal(int signal, void *data)
{
...
static void
handle_wlr_log(enum wlr_log_importance importance, const char *fmt,
               va_list args)
{
