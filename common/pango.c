                 ...
                 const char *text, double scale, bool markup)
{
    ...
    pango_context_set_round_glyph_positions(pango_layout_get_context(layout),
                                            false);
...
void
get_text_size(cairo_t *cairo, const PangoFontDescription *desc, int *width,
...
void
get_text_metrics(const PangoFontDescription *description, int *height,
                 int *baseline)
{
